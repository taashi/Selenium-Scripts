//filter functionality check - all
...
//		WebDriver driver;
		 ...
		 System.setProperty("webdriver.chrome.driver","C:\\Users\\Taashi Priya\\Downloads\\chromedriver_win32\\chromedriver.exe");
...
//			driver = new FirefoxDriver(options);
			...
			WebElement x = driver.findElement(By.xpath("//body/table[1]/tbody[1]/tr[1]/td[1]"));
			String y = x.getText();
			int result = Integer.parseInt(y);
			WebElement tname = driver.findElement(By.name("task_name"));
			tname.sendKeys("editing");
			WebElement tdate =  driver.findElement(By.name("due_date"));
			tdate.click();
			
			tdate.sendKeys("05-05-2018");
